...
3. `pacman -Syu`
4. Add `export XDG_DATA_DIRS="/ucrt64/share:${XDG_DATA_DIRS:-/usr/local/share/:/usr/share/}"` at the end of `~/.bashrc` and restart MSYS2
5. `pacman -S --needed base-devel mingw-w64-ucrt-x86_64-toolchain --overwrite; pacman -S mingw-w64-ucrt-x86_64-gtkmm-4.0`
