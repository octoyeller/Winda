...
Cross-platform template for GUI C++ apps utilizing GTK 4. Features proper window decorations. Does require a set-up to 
work.
...
First of all F you, because apparently there isn't any native compiler for windows (except for VS which I 
don't like and Clion which I cannot afford). So I'm using LINUX to compile this thing.
...
Doesn't work? Sucks to be you ¯\_(ツ)_/¯ I guess. I'm on a stage of screw the tech return to paper. If you need help 
I suggest you also relearn how to use the damn pen.